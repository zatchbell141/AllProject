  ...
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      <ul class="inline">
         ...
         <li><i class="fa fa-envelope-o"></i><h2><?php echo $_SESSION['admin_user']?></h2></li>
      </ul>
    </div>
    <!-- ################################################################################################ --> 
  </header>
  ...
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      ...
      <!--<li><a class="drop" href="#">Pages</a>
       ...
       <li  class="active"><a href="notesem1.php">Uploads</a></li>
...
<div class="wrapper row3">
  ...
  <main class="container clear"> 
    ...
    <div class="content"> 
      ...
      <p style="color:red;">You can upload your Notes here for students.Please upload File One by One.</p>
       <form  action="notesem1.php" method="post"  enctype="multipart/form-data">
      <table>
        <tbody>
          <tr>
            <td colspan="2">File Name:<input type="text" name="txtfilename" required></td>
          </tr>
          <tr>
            <td colspan="2">
            Please Upload Files:<input type="file" name="ebooks"   accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf" />
          </td>
        </tr>
          <tr>
          
       
          <td>You Are sending this file to this year:<select name="txtyrs" id="ddl" onchange="configureDropDownLists(this,document.getElementById('ddl2'))">
         ...
         <td>
           Please Select sem:<select name="txtsem" id="ddl2">
        ...
        <tr>
                   <td colspan="2">
           Please Select Mode:<select name="txtmode" >
        ...
        <tr>
            <td colspan="2"><input type="hidden" name="txtdate" value="<?php echo date("d/m/Y")?>" required></td>
          </tr>
        <tr>
          <td colspan="2"><input type="submit" name="import" class="button button4" value="Upload" /></td>
           </form>
         </tr>
...
if(isset($_POST['import']))
{
    ...
    $sem=protect($_POST['txtsem']);
     $username=protect($_SESSION['admin_user']);
    $mode=protect($_POST['txtmode']);
    $date=protect($_POST['txtdate']);
    $date=strtotime($date);
    $date=date('Y-m-d',$date);
    $sql="insert into files(years,sem,file,filetype,active,date,mode,username) values('$year','$sem','$Name','$image','1','$date','$mode','$username')";
        ...
        <table>
          ...
          <tbody>
             <?php
              $username=protect($_SESSION['admin_user']);
                                    include 'Conn.php';
                                    $sql="select * from files where username='".$username."'and  active='1' ORDER BY id DESC";
...
function configureDropDownLists(ddl1, ddl2) {
  var colours = ['SEM I', 'SEM II'];
  var shapes = ['SEM III', 'SEM IV'];
  var names = ['SEM V', 'SEM VI'];
