 		...
 		<?php include 'Includes/menu.php';?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">SYBCA Direct Online Form Details</h1>
                        </div>
                         ...
                         <div class="col-lg-12">
                             ...
                             <div class="panel panel-default">
                                <div class="panel-heading">
                                  <h3 class="panel-title">SYBCA Direct Online Form Details</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    $sql="select DISTINCT a1.fullname ,a1.id ,a1.stdphoto  from addonline a1,receipt r1 where a1.admyrs='2020-2021 Year' and a1.fullname=r1.fullname and a1.course='Bachelor of Computer Applications- R- Direct Second' and a1.active='1' and r1.year='SYBCA' order by a1.id DESC";
