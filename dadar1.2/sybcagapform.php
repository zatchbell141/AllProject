 		...
 		<?php include 'Includes/menu.php';?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">SYBCA Gap Online Form Details</h1>
                        </div>
                        ...
                        <div class="col-lg-12">
                             ...
                             <div class="panel panel-default">
                                <div class="panel-heading">
                                  <h3 class="panel-title">SYBCA Gap Online Form Details</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    $sql="select a1.id,a1.stdphoto,a1.fullname from addonline a1,receipt r1 where a1.admyrs='2020-2021 Year' and a1.fullname=r1.fullname and a1.course='Bachelor of Computer Applications- R- GAP Second Year' and r1.receipttype='TMVFEES' and a1.active='1' order by a1.id desc";
