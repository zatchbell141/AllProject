                                    ...
                                    if($result->num_rows>0)
                                    {
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                            ...
                                            <!--<td><a href="delstudent.php?varname=<?php echo $row['studentid'];?>">Delete</a></td>-->
                                             <td><button class="btn btn-danger notika-btn-danger btn-lg"  onClick="deleteme(<?php echo $row['id']; ?>)">Replay</button>
                                             </tr>
                                             ...
                                             window.location.href='printbonafide.php?varname=' +delid+'';
                                             return true;
                                             }
                                             } 
                                             </script>
                    ...
                    <div class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="past-day-statis">
                            ...
                            <p>
                                ...
                                <?php
                                    include 'Conn.php';
                                    $sql="select * from msg where active=1  ORDER BY id DESC";
                                    $result=$con->query($sql);
                                    if($result->num_rows>0)
                                    {
                                        $no=0;
                                        while($row=$result->fetch_assoc())
                                        {
                                            $no++;
                                            $sid=$row['username'];
                                            $sidsql="select * from studreg where active=1 and studentid='$sid'";
                                            $sidresult=$con->query($sidsql);
                                            $sidrow=$sidresult->fetch_assoc();
                                            ?>
                                            <tr>
                                               
                                                <td><?php echo $sidrow['fullname']?></td>
