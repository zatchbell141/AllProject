                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <form action="updatestudentsd.php" method="post" autocomplete="off">
                                    ...
                                    if($result->num_rows>0)
                                    {
                                        while($row=$result->fetch_assoc())
                                        {
                                            ...
                                            <tr class="info">
                                                ...
                                                <td><button class="btn btn-warning notika-btn-warning" name="btnsubmit">Update</button></td>
                            ...
                            <?php include 'updatestudentdta.php';?>
                        </div>
                    </div>
                </div>
            </div>
