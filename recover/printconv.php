...
<body>
     <div align="center" id="hiderow" ><h1><input type ="submit"  value ="Print" onclick="window.print()" name="tsubmit"></h1></div>
        <div align="center" id="hiderow" ><a  href="convo.php" >back to College Fees</a><br/>
		   ...
		   Year:&nbsp;<?php echo $row['Year'];?> &nbsp;SEM:&nbsp;<?php echo $row['Sem'];?><br>
            ...
            $pt=$row['PaymentType'];
                ...
                if($pt=="NEFT" or $pt=="MT")
                {
				    ...
				    echo "<p  style='font-size:120%;'>Remitter Bank:$cb</p>"; 
			 		echo "<p  style='font-size:120%;'>Beneficiary Bank:$benb</p> "; 
			 	
                }
                if($pt=="TMV Fees" or $pt=="MT")
                {
                   	//echo "<p  style='font-size:120%;'>NEFT Number:$cn<br>";
					echo "<p  style='font-size:120%;'>Date:$cd<br>";
				    echo "<p  style='font-size:120%;'>Remitter Bank:$cb</p>"; 
		     ...
		     <th>Sr.No</th>
		      ...
		      <th>Amount</th>
		      	...
		      	<tr>
		      		...
		      		<td>Others-<b>Convocation Fees</b></td>
