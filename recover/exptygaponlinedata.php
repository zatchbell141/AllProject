...
$output .='
                    ...
                    header("Content-type: application/octet-stream"); 
										header("Content-Disposition: attachment; filename=TYGAPOnlineAdmission.xls"); 
