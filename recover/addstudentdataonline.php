...
$sql="INSERT INTO `addonline`(`id`, `stdphoto`, `coursecode`, `course`, `addmissionstatus`, `centercode`, `name`, `lastname`, `middlename`, `fathername`, `mothername`, `dob`, `gender`, `email`, `contact`, `statusm`, `caste`, `aadhar`, `address`, `state`, `pin`, `qulic1`, `qulic2`, `univer1`, `univer2`, `year1`, `year2`, `per1`, `per2`, `hsc`, `dobcertif`, `aadhrcd`, `others`, `active`,`fullname`,`date`) 
VALUES('','$target1','$coursecode','$course','$admissionsts','$centercode','$name','$lastname','$fathername','$fathername','$mothername','$dobd','$gender','$email','$contact','$statusm','$caste','$aadhar','$localaddres','$state','$pin','$qulic1','$qulic2','$colgun1','$colgun2','$passingy1','$passingy2','$per1','$per2','$target4','$target34','$target2','$target5','1','$fullname','$date')";
