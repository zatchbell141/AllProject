        ...
        <div class="container">
            <div class="row">
               ...
               <table class="table table-sc-ex table-bordered">
                <tr>
                  <td> <div class="nk-int-st"><input type="text" class="form-control input-lg"  name="txtsubjectcode" placeholder="Subject Code" required></div></td>
                  <td> <div class="nk-int-st"><input type="text" class="form-control input-lg"  name="txtsubjectname" placeholder="Subject Name" required></div></td>
                </tr>
                <tr>
                  <td>Sem:<select class="form-control" class="form-control input-lg" name="txtsem" width="10px">
                  ...
                  <td>Edition:<select class="form-control" class="form-control input-lg" name="txtedition" width="10px">
                ...
                <tr>
                  <td colspan="2"><button class="btn btn-primary notika-btn-primary btn-lg" id="submit">Add Subject</button></td>
                </tr>
                <tr>
