...
$output .='
                    ...
                    $sql="select DISTINCT a1.fullname ,a1.id ,a1.stdphoto,a1.prn,a1.fullname,a1.contact,a1.state,a1.pin,a1.address,a1.date,a1.course,a1.addmissionstatus,a1.dob from addonline a1,receipt r1 where a1.admyrs='2020-2021 Year' and a1.fullname=r1.fullname and a1.course='Bachelor of Computer Applications- R- Direct Third Year' and a1.active='1' and r1.year='TYBCA' order by a1.prn asc";
