...
include 'Conn.php';
    ...
    $name=$row['fullname'];
    $feessql="select * from receipt where FullName='$name' and receipttype='TMVFEES' order by id desc";
...
?>
    ...
    <table class="table table-border table-hover">
        ...
        <tr>
            <td><img src="http://stdm.bcaedu.in/BCAForm/<?php echo $row['stdphoto'];?>" height="200"  width="150"></td>
            <td><img src="http://stdm.bcaedu.in/BCAForm/<?php echo $row['sign'];?>" height="200"  width="150"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><b>Board:<?php echo $unv2row['name'];?></b></td>
        ...
        ?>
         <tr>
            ...
            <td><b>Board:<?php echo $uni2row['name'];?></b></td>
        ...
        <tr>
            <td><b><a href="http://stdm.bcaedu.in/BCAForm/<?php echo $row['aadhrcd'];?>" target="_blank">Aadhar Card</a></b></td>
            <td><b><a href="http://stdm.bcaedu.in/BCAForm/<?php echo $row['hsc'];?>" target="_blank">HSC</a></b></td>
            <td><b><a href="http://stdm.bcaedu.in/BCAForm/<?php echo $row['dobcertif'];?>" target="_blank">DOB</a></b></td>
            <td><b><a href="http://stdm.bcaedu.in/BCAForm/<?php echo $row['others'];?>" target="_blank">Other</a></b></td>
            <td>&nbsp;</td>
        </tr>
         <tr class="success">
        ...
        <tr>
            <td colspan="5"><img src="http://stdm.bcaedu.in/BCAForm/<?php echo $imgfeesrow['file'];?>" height="200"  width="1300"></td>
        </tr>
    </table>
