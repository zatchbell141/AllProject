             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sale-statistic-inner notika-shadow mg-tb-30">
                        <div class="curved-inner-pro">
                             <article>
                                <form action="exportexcelconvo.php" method="post">
                                    <table class="table table-sc-ex table-bordered">
                                        <tr>
                                            <th align="center" colspan="2"><h1>Date Wise</h1></th>
                                        </tr>
                                        <tr>
                                            <td>Start Date:<div class="nk-int-st"><input type="date" name="std" class="form-control input-lg"></div></td>
                                            <td>End Date:<div class="nk-int-st"><input type="date" name="endd" class="form-control input-lg"></div></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                        </tr>
                                     ...
                                     <article>
                                <form action="exportexcelconvoexam.php" method="post">
                                    <table class="table table-sc-ex table-bordered">
                                        <tr>
                                            <th align="center" colspan="2"><h1>Exam Year</h1></th>
                                        </tr>
                                        <tr>
                                            <td>Exam Year:<select name="txtexamyrs" class="form-control">
