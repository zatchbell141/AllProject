...
$output .='
                    ...
                    if(mysqli_num_rows($result)>0)
                    {
                        ...
                        $fullname=$row['fullname'];
                         $feessql="select * from receipt where year='SYBCA' and FullName='$fullname'";
