     ...
     <div class="sale-statistic-area">
        <div class="container">
                    ...
                    <div class="sale-statistic-inner notika-shadow mg-tb-30">
                        <div class="curved-inner-pro">
                            <div class="curved-ctn" align="center">
                                 <form action="tmvfees.php" method="post" autocomplete="off">
         ...
         ?>
                    ...
                    <form id="addform" action="addtmvfees.php" method="POST" autocomplete="off">
                           <table class="table table-sc-ex table-bordered">
                                    <tr>
                                        <td>
                                            <div class="nk-int-st">
                ...
                <input type="hidden"  name="txtcentreno" value="<?php echo $row['CenterFormNo'];?>" placeholder="PRN" readonly>
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" class="form-control input-lg" name="txtsem" value="<?php echo $frow['sem'];?>" placeholder="Year" readonly>
                                         ...
                                         <td><div class="nk-int-st">
                                        <input type="text" class="form-control input-lg" name="txtrecty" value="TMVFEES" placeholder="Year" readonly>
                                    </div></td>
                                   
                                        <td><div class="nk-int-st">
                                        <input type="text" class="form-control input-lg" name="txtfees" value="<?php echo $frow['tmvFees'];?>" placeholder="Fees" readonly>
                                    </div></td>
                                     ...
                                     <tr>
                                       ...
                                       <td>
                                        <div class="nk-int-st">
                                        <input type="text" class="form-control input-lg" name="txtfeesmode" value="<?php echo $frow['mode'];?>"  readonly>
                                    </div>
                                    </td>
                                      </tr>
                                    <tr>
