            ...
            <div class="row">
               <!-- <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">-->
                    <div class="sale-statistic-inner notika-shadow mg-tb-30">
                        ...
                        <form action="expsydirect.php" method="post">
                           ...
                           <div class="table-responsive">
                                     ...
                                     <table class="table table-bordered  table-hover">
                                            ...
                                            <tr>
                                                 <?php
                                    include 'Conn.php';
                                    $sql="select a1.id,a1.stdphoto,a1.fullname from addonline a1,receipt r1 where a1.admyrs='2020-2021 Year' and a1.fullname=r1.fullname and a1.course='Bachelor of Computer Applications- R- Direct Second' and a1.active='1' and r1.year='SYBCA' order by a1.id desc";
                                    ...
                                    if($result->num_rows>0)
                                    {
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                            ...
                                            <td><?php echo $row['fullname'];?></td>
                                             ...
                                             <td><a class="btn btn-danger notika-btn-danger btn-lg" href = "viesydirect.php?varname=<?php echo $row['id'];?>">View</a></td>
