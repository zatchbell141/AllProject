            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="widget-tabs-int tab-ctm-wp mg-t-30">
                        ...
                        <form action="exportbalconsoleyashfees.php" method="POST">
                                                <table class="table table-striped" border="1">
                                                    <tr>
                        ...
                        <form action="" method="POST">
                                                <table class="table table-striped" border="1">
                                                    ...
                                                    <tr>
                                                        <td colspan="2"><button id="submit" name="btnsrch" class="btn btn-primary notika-btn-primary">Search</button></td>
                                                        </form>
                                                    </tr>
                                                </table>
                                                ...
                                                <?php
                                                    ...
                                                    if($result->num_rows>0)
                                                    {
                                                        ...
                                                        while($row=$result->fetch_assoc())
                                                        {
                                                            ...
                                                            $recpsql="select SUM(Paid) as Paid, Total from receipt where FullName='$stid' and Receipttype='TMVFEES' and Year='FYBCA' ORDER BY id DESC";
                                                ...
                                                <?php
                                                    ...
                                                    if($result->num_rows>0)
                                                    {
                                                        ...
                                                        while($row=$result->fetch_assoc())
                                                        {
                                                            ...
                                                            $yrs=$row['admissionyrs'];
                                                            $recpsql="select SUM(Paid) as Paid, Total from receipt where FullName='$stid' and Receipttype='TMVFEES' and Year='".$feesrow['year']."' ORDER BY id DESC";
                                                            $recpresult=$con->query($recpsql);
                                                            $recprow=$recpresult->fetch_assoc();
