            ...
            <div class="row">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sale-statistic-inner notika-shadow mg-tb-30">
                                 ...
                                 <form action="colgfees.php" method="post" autocomplete="off">
                ...
                <input type="hidden"  name="txtcentreno" value="<?php echo $row['admissionyrs'];?>" placeholder="PRN" readonly>
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" class="form-control " name="txtsem" value="<?php echo $frow['sem'];?>" placeholder="Year" readonly>
                                         ...
                                         <td><div class="nk-int-st">
                                        <input type="text" class="form-control " name="txtrecty" value="BCAFEES" placeholder="Year" readonly>
                                    </div></td>
                                     ...
                                     <tr>
                                       ...
                                       <td colspan="2">
                                        <div class="nk-int-st">
                                        <input type="text" class="form-control " name="txtfeesmode" value="<?php echo $frow['mode'];?>" placeholder="Fees Mode" readonly>
                                    </div>
                                    </td>
                                      </tr>
                                    <tr>
