...
$fsql="select ReceiptNewNo,Paid from receipt where FullName='".$row['FullName']."' and active='1' and Receipttype='TMVFEES' ORDER BY id ASC";
...
<body>
     <div align="center" id="hiderow" ><h1><input type ="submit"  value ="Print" onclick="window.print()" name="tsubmit"></h1></div>
        <div align="center" id="hiderow" ><a  href="tmvbalfees.php" >back to College Fees</a><br/>
