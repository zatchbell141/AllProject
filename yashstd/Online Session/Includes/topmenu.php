 <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><h1> <img src="images/logo1.png" alt="" /> </h1></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
			<div class="top-search">
				<form class="navbar-form navbar-right" action="searchvideos.php" method="POST">
				 ...
				 <script language="javascript">
                   function deleteme()
                   {
                   	var desp=document.getElementById("txtsearch").value;
                   /*if(confirm("Are You Sure you want to do replay:"+" "+desp)){*/
                   window.location.href='searchvideos.php?search=' +desp+'';
                   /*return true;
                   }*/
                   } 
                   </script>
			...
			<div class="header-top-right">
				<div class="file">
					<a><?php echo  $_SESSION['login_username'];?></a>
				</div>	
				<!-- <div class="signin">
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											<form>
												...
												<input type="text" class="email" placeholder="Last Name" required  />
												<input type="text" class="email" placeholder="Username"  required />
