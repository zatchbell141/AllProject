			...
			<div class="main-grids">
				 <div class="top-grids">
					...
					<?php
                                    ...
                                    {
                                    	$desp=$_POST['txtsearch'];	
                                    }
                                    
                                    $sql="select * from videos where active='1' and desp like '%$desp%' ORDER BY id DESC";
                                    $result=$con->query($sql);
                                    if($result->num_rows>0)
                                    {
                                        while($row=$result->fetch_assoc())
                                        {
                                        		$adminid=$row['uploadby'];
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						<div class="resent-grid-img recommended-grid-img">
							<a href="playvideos.php?url=<?php echo $row['id'];?>"><img src="<?php echo $row['pic'];?>" alt="" /></a>
							<div class="time">
								<p style="color: black;"><?php echo $row['duration'];?></p>
							</div>
							<div class="clck">
						...
						<div class="resent-grid-info recommended-grid-info">
							<h3><a href="playvideos.php?url=<?php echo $row['id'];?>" class="title title-info"><?php echo $row['desp']?></a></h3>
							<ul>
								<li><p class="author author-info"><a href="#" class="author"><?php echo $adminrow['fullname']?></a></p></li>
								<li class="right-list"><p class="views views-info">1 views</p></li>
							</ul>
						</div>
					</div>
					<?php
