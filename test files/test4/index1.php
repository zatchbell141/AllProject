...
<div class="card">
  <div class="row">
    <div class="col">
      <h4>Past version</h4>
      <div id="originalHTML" style="display: none;"><?php echo htmlentities(readfile("RAJASLU CEMENT.htm"));?></div>
      <div id="newHTML" style="display: none;"><?php echo htmlentities(readfile("RAJASLU CEMENT1.htm"));?></div>
...
<script>
  ...
  let originalHTML = document.getElementById("originalHTML").innerHTML;
