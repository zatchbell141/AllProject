...
<?php 															
                                ...
                                $testid=$_SESSION['testid'];
																...
																$fetchqry2 = "INSERT INTO `userans`(`id`, `testid`, `questionid`, `userans`,`studentid`,`studentnm`) 
                                VALUES ('','$testid','$c','$userselected','1','atul')"; 
...
<table><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `quiz` where id='$c'"; 
				...
				$row = mysqli_fetch_array($result,MYSQLI_ASSOC); $_SESSION['testid']=$row['testid'];}
		  ?>
