             ...
             <form id="addform" action="adddsuject.php" method="post">
               ...
               <table class="table">
                <tr>
                  ...
                  <td>Subject Name:<input type="text"  class="form-control" name="txtsubjectname" placeholder="Subject Name" required></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2"><button class="btn btn-primary" id="submit">Submit</button></td>
                </tr>
                <tr>
