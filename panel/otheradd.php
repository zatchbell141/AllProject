...
date_default_timezone_set("Asia/Kolkata");
  $receipt=date("Ydmhis");
    ...
    $recmode=protect($_POST['receiptmode']);
    $bal=$tfees-$paid;
    if($bal>=0)
    {
        ...
        $sql="insert into others values('', '$receipt', '$prn', '$name', '$lastname', '$year', '$sem', '$mode', '$payment', '$chequeno', '$chequedate', '$bank', '$tfees', '$paid', '$bal','$late','$date','$recmode')";
