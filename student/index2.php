...
include 'Conn.php';
 ...
 $sql="select * from examtime  ORDER BY id DESC";
...
?>
      ...
      <table>
        ...
        <tr>
          <td><b><?php echo $row['date'];?></td></b>
          <td><b><?php echo "<a href='//localhost:81/tech/Doc/".$row['file']."'>".$row['file']."</a>"?></b></td>
...
include 'Conn.php';
$yrs=$_SESSION['year'];
 $sql="select * from assign where year='$yrs' ORDER BY id DESC";
 $result=$con->query($sql);
  $row=$result->fetch_assoc()
?>
      ...
      <h2>Assignments</h2>
      <hr>
      <b>Date of upload:<?php echo $row['date'];?><br/><b/>
     <b>Year:<b><?php echo $row['year'];?><br/><b/>
      Sem:<?php echo $row['sem'];?><br/><b/>
     <?php echo "<a href='//localhost:81/tech/Doc/".$row['file']."'>".$row['file']."</a>"?>
    <div class="clear"></div>
</main>
</div>
