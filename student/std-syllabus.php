...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="one_half first">
      <h1 class="logoname"><a href="index2.html"><span>Yash</span>Infotech</a></h1>
    </div>
    <div class="one_half">
    ...
    <div class="card">
          <table>
            ...
            <?php
                                    include 'Conn.php';
                                    $year=$_SESSION['year'];
                                    $sql="select * from syllabus where year='' ORDER BY id DESC";
...
<td><?php echo "<a href='//localhost:81/tech/Doc/".$row['file']."'>".$row['file']."</a>"?></td> 
<?php
}
}
 ?>      
