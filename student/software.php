   ...
   <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
     ...
     <li><a href='std-examtime.php'> Time-Table</a></li>
      <li  class="active"><a  href="#">E-Learning</a>
      <ul>
          <!--<li><a href="#">FYBCA</a></li>-->
     ...
     <h2>Softwares</h2>
      <table>
        ...
        <tr>
          ...
          <td>It's Works On window 8 64 bit machine.This for Vb.net and Asp.net C#.This is font end software for your application.</td>
          <td><a herf="#">Download</a></td>
        </tr>
         <tr>
          <td>Visual Studio 2010</td>
          <td>It's Works On all systems.This for Vb.net and Asp.net C#.This is font end software for your application.</td>
          <td><a herf="#">Download</a></td>
        </tr>
         <tr>
          <td>Sql Server 2008</td>
          <td>It's Works On all systems.This is back end software for your application.</td>
          <td><a herf="#">Download</a></td>
        </tr>
         <tr>
         ...
         <tr>
          <td>XXamp server</td>
          <td>It's Works On all systems.This is use for Php back end software</td>
          <td><a herf="#">Download</a></td>
        </tr>
         <tr>
          <td>Turbo C</td>
          <td>It's Works On all systems.</td>
          <td><a herf="#">Download</a></td>
        </tr>
        <tr>
          <td>Java JDK</td>
        ...
        <tr>
          <td>Sublime Text</td>
          <td>It's Works On all systems.This is use for your Web application. HTML,CSS,JAVASCRIPT.</td>
          <td><a herf="#">Download</a></td>
        </tr>
        <tr>
          <td>Notepad++</td>
