    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Balance Fees</h1>
          <div class="page-header">
<div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">Student's Details</h3>
            </div>
          ...
          <table  class="table table-striped">
            <tr>
              <td>Order ID:<div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input placeholder="Firstname" class="form-control" type="text" list="dtstud" name="txtaddname"></td>
               <datalist id="dtstud">
                      <?php
                                include 'Conn.php';
                                 $query1="select * from receipt where active=1 and instlbal>0";
                                 ...
                                 ?>
                                 <option value="<?php echo $grd['id'];?>"><?php echo $grd['fullname']."--".$row['name'];?></option>
                                 <?php
                                 }
                                 ?>
                    </datalist>
              ...
              <!--<td>
                Receipt Mode:<select name="txtmode" id="mode" onchange="changetextbox1();">
               ...
               <!--<td>Admitted By:
             <select class="form-control" name="txthandle">
              <?php
                include 'Conn.php';
         ...
         if(isset($_POST['txtsrchuser']))
          {
            include 'Conn.php';
            $admitted=$_POST['txthandle'];
            $name=$_POST['txtaddname'];
             $sql="select * from receipt where id='".$name."' ORDER by id DESC";
             $result=$con->query($sql);
             $row=$result->fetch_assoc();
             
             $recptno=$row['receiptNo'];
             $rn=$recptno+1;
         ...
         <table  class="table table-striped">
             <input type="hidden" value="<?php echo $row['studentid'];?>" name="txtstudid" Placeholder="Name">
               <input type="hidden" value="<?php echo $row['coursemode'];?>" name="txtcoursem" Placeholder="Name">
             <tr>
                 <td>Receipt No:<input type="text" class="form-control" value="<?php echo $rn;?>" readonly name="txtreceno" Placeholder="Receipt No"></td>
                 <td>Date:<input type="text" class="form-control"value="<?php echo date("d-m-Y");?>" readonly name="txtdate" Placeholder="Date"></td>
            
                 <td>Student Name:<input type="text" class="form-control" value="<?php echo $row['fullname'];?>" name="txtstudname" Placeholder="Name"></td>
                  </tr>
             <tr>
                 <td>Other Details/Course Name:<input class="form-control"type="text" value="<?php echo $row['coursename'];?>" name="txtcourse" Placeholder="Name"></td>
            
                 <td>Total Fees:<input type="text"class="form-control" value="<?php echo $row['instlbal'];?>" name="txtfees" Placeholder="Total fees"></td>
                 <td>Paid Fees:<input type="text"class="form-control" name="txtpaid" Placeholder="Paid fees"></td>
             </tr>
             <tr>
                ...
                <td>Cheque Date:<input type="date" id="txtchequd" class="form-control"name="txtchequd" placeholder="Cheque Date" required></td>
                <tr>
                <td>Bank:<input type="text" id="txtbank" class="form-control"name="txtbank" placeholder="Bank" required></td>
     
          <td>
             Due Date:<input type="text" id="txtdue" class="form-control"name="txtinstallment" value="<?php echo $row['instaldate'];?>" placeholder="Due Date" required>

          </td>
           <td>Form Number:<input type="text" class="form-control"value="<?php echo $row['fromno'];?>" readonly name="txtformno" Placeholder="Form Number"></td>
           <tr>
           <td colspan="1">Admitted By:<input class="form-control"type="text" value="<?php echo $_SESSION['staffid'];?>"  name="txtadmit" Placeholder="Name" readonly></td>
           <td colspan="1">Batch Time:<input class="form-control"type="text"  value="<?php echo $row['batch'];?>" required name="batch" Placeholder="Discount">
           </td>
           <td>Discount:<input type="text"  class="form-control"required name="txtdisc" value="<?php echo $disc;?>" Placeholder="Discount"></td>
      </tr>
      <tr>
                <td colspan="4"><button class="btn btn-warning" id="submit">Submit</button></td>
                </form>
              </tr>
              <tr>
 ...
 <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">Balance Fees Details</h3>
            </div>
            <div class="panel-body">
              <div  class="ex2">
               <table class="table table-striped">
         ...
         <th>Print</th>
          	...
          	<tbody>
          		<tr>
          		 <?php
                                    include 'Conn.php';
                                    $sql="select * from balance where active='1' ORDER BY id DESC";
                                    $result=$con->query($sql);
                                    if($result->num_rows>0)
                                    {
                                        $no=0;
                                                      ...
                                                      <td><?php echo $row['balance'];?></td>
                                                       ...
                                                       <td><?php echo $row['chequeno'];?></td>
                                                        ...
                                                        <td><?php echo $row['bank'];?></td>
                                                         <td><input type="button" class="btn  btn-info"  onClick="print(<?php echo $row['id'];?>)" name="Print" value="Print"></td>
                                            </tr>
                                            <script language="javascript">
                                             function print(delid)
                                             {
                                             if(confirm("Do you want Edit this record....!")){
                                             window.location.href='balanceprint.php?varname=' +delid+'';
                                             return true;
                                             }
                                             } 
