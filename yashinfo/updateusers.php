      ...
      <section id="latest">-->
       <h1 align="center">Update Users</h1>
        ...
        <article>
            ...
            <tr>
              <td>Name:<input type="text" list="browsers" name="txtaddname" Placeholder="Name"></td>
               <datalist id="browsers">
                      <?php
                                include 'Conn.php';
                                 $query1="select fullname from users";
         ...
         <form id="addform" action="updaterusers.php" method="post">
         <table>

          <tr>
              <input type="hidden"  name="txtsubjectid" value="<?php echo $row['studentid']?>" required>
              <td colspan="3">Fullname:<input type="text" name="txtaddfullname" value="<?php echo $row['fullname']?>"  readonly></td>
            </tr>
            <tr>
              <td>Name:<input type="text" name="txtaddname"  value="<?php echo $row['name']?>" readonly></td>
              <td>Lastname:<input type="text" name="txtaddlastname" value="<?php echo $row['lastname']?>" readonly></td>
              <td>Username:<input type="text" name="txtaddusername" value="<?php echo $row['username']?>"  required></td>
          </tr>
          <tr>
             <td>Year:<input type="text" name="txtaddyear" value="<?php echo $row['year']?>" readonly></td>
              <td>Sem:<input type="text" name="txtaddsem" value="<?php echo $row['sem']?>" readonly></td>
              
              <td>Password:<input type="text" name="txtaddpasswd" value="passwd" Placeholder="Name" required></td>
          </tr>
          <tr>
            <td colspan="3"><button class="button button3" id="submit">Update</button></td>
            </form>
          </tr>
           <tr>
