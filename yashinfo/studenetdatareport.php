...
<link rel="stylesheet" href="layout/styles/tab.css" type="text/css">
...
<br>
    ...
    <div class="tab">
  <button class="tablinks" onclick="openCity(event, 'FYBCA')">FYBCA</button>
  <button class="tablinks" onclick="openCity(event, 'SYBCA')">SYBCA</button>
  <button class="tablinks" onclick="openCity(event, 'TYBCA')">TYBCA</button>
  <button class="tablinks" onclick="openCity(event, 'attend')">Attendence</button>
</div>
 <div class="ex3">
