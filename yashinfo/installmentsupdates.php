...
<div class="wrapper row3">
  <div id="container" class="clear"> 
    ...
    <div id="homepage"> 
      ...
      <!-- Latest 
      <section id="latest">-->
       <h1>Intsallments Update</h1>
         <div class="col-75">
        <div class="container">
        <article>
          <form action="installmentsupdates.php" method="post">
          <table>
            <tr>
         ...
         ?>
         <form id="addform" action="installmentsupdate.php" method="POST">
          <table>
             <tr>
              <td colspan="2"> Date:<input type="text" class="form-control" name="lbdate" value="<?php echo $row['date'];?>" required></td>
              <td colspan="1"> Receipt No:<input type="text" class="form-control" name="receipo" value="<?php echo $row['receiptNo'];?>" readonly></td>
              <td colspan="1"> PRN:<input type="text"  name="txtprn" value="<?php echo $row['prn'];?>" placeholder="PRN" required></td>
            </tr>
              <input type="hidden"  name="txtidothers" value="<?php echo $row['id'];?>"  required>
              <tr>
