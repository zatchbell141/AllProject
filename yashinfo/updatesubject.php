      ...
      <section id="latest">-->
        ...
        <article>
         <form action="updatesubject.php" method="POST">
            <table>
              <tr>
                <td>Name:<input type="text" name="txtssubjectname" list="browsers" placeholder="Name" required></td>
              ...
              <tr>
                <td><input type = "submit" class="button button3"  value ="submit" name="subjectsrch"></td>
              </tr>
            </table>
          </form>
                 <?php
           ...
           <form id="addform" action="updatecsubject.php" method="post">
               <table>
                ...
                <tr>
                  <td>Subject Code:<input type="text"  name="txtsubjectcode" value="<?php echo $srow['code']?>" required></td>
                  <td>Subject Name:<input type="text"  name="txtsubjectname" value="<?php echo $srow['name']?>" required></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2"><button class="button button2" id="submit">Update</button></td>
                </tr>
                <tr>
