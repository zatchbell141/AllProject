        ...
        <article>
            ...
            <tr>
              <td>Name:<input type="text" list="browsers" name="txtaddname" Placeholder="Name"></td>
               <datalist id="browsers">
                      <?php
                                include 'Conn.php';
                                 $query1="select name from others";
         ...
         include 'Conn.php';
          if(isset($_POST['txtsrchuser']))
          {
            ...
            $sql="select * from others where name='".$name."'";
           $result=$con->query($sql);
           $row=$result->fetch_assoc();
          }

         ?>
         <form id="addform" action="updaterothers.php" method="POST">
          <table>
             <tr>
              <td colspan="2"> Date:<input type="text" class="form-control" name="lbdate" value="<?php echo $row['date'];?>" required></td>
              <td colspan="2"> Receipt No:<input type="text" class="form-control" name="receipo" value="<?php echo $row['receiptNo'];?>" readonly></td>
            </tr>
              <input type="hidden"  name="txtidothers" value="<?php echo $row['id'];?>" placeholder="PRN" required>
              <tr>
                <td>PRN:<input type="text"  name="txtprn" value="<?php echo $row['prn'];?>" placeholder="PRN" required></td>
              ...
              <tr>
                <td colspan="4"><button class="button button2" id="submit">Update</button></td>
                </form>
              </tr>
              <tr>
