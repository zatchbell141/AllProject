  ...
  <div id="container" class="clear"> 
    ...
    <div id="homepage"> 
      ...
      <section id="latest">-->
        ...
        <article>
          <form action="updateadmin.php" method="POST">
            <table>
              <tr>
                <td>Username:<input type="text" name="txtdname" placeholder="Username" required></td>
              </tr>
              <tr>
                <td> <input type = "submit" class="button button3"  value ="submit" name="sdname"></td>
              </tr>
            </table>
          </form>
          <?php
                            if(isset($_POST['sdname']))
                            {
                                    include 'Conn.php';
                                    $name=$_POST['txtdname'];
                                    $sql="select * from admin  where username like '%".$name."%'";
      ...
      <div class="col-75">
        <div class="container">
        <article>
           <form id="addform" action="updatedadmin.php" method="post">
               <table>
                                <tbody>
                                    <tr>
                   
                    <td colspan="2">Name:<input type="text"  name="txtname" value="<?php echo $row['name']?>"  placeholder="Name" required></td>
                    <td colspan="2">Lastname:<input type="text" name="txtlastname" value="<?php echo $row['lastname']?>" placeholder="Lastname" required></td>
                  </tr>
                    <tr colspan="2">
                    <td>Username:<input type="text" name="txtusername" value="<?php echo $row['username']?>" placeholder="Username" readonly></td>
                    <td colspan="2">Password:<input type="text"  name="txtpasswd"  value="<?php echo decrypt($row['passwd'],$key)?>"  placeholder="Password" required></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                        Email: <input type="text" name="txtemail" value="<?php echo $row['email']?>" placeholder="Email" required>
                    </td>
                   <td colspan="3">Contact:<input type="text" value="<?php echo $row['contact']?>" name="txtcontact" placeholder="Contact" required></td>        
                    </tr>
                    <tr>
                      <td colspan="5"><button class="button button2" id="submit">Update</button></td>
                    </form>
                    </tr>
                    <tr>
