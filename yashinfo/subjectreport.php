...
<div class="wrapper row3">
  <div id="container" class="clear"> 
    ...
    <div id="homepage"> 
      ...
      <section id="latest">-->
        <article>
<h1>Completed Subject in Hours</h1>
        <div class="col-75">
        <div class="container">
        <article>
          ...
          <table>
            ...
            <tr>
              <td colspan="2"><input type = "submit" class="button button3"  value ="submit" name="salsh"></td>
              </form>
            </tr>
          </table>
          <table>
