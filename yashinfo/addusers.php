        ...
        <article>
         ...
         <table>
          ...
          <tr>
            ...
            <tr>
              <td>Name:<input type="text" name="txtaddname"  value="<?php echo $row['firstname']?>" readonly></td>
              <td>Lastname:<input type="text" name="txtaddlastname" value="<?php echo $row['lastname']?>" readonly></td>
              <td>Username:<input type="text" name="txtaddusername" placeholder="Username" required></td>
          </tr>
          <tr>
             <td>Year:<input type="text" name="txtaddyear" value="<?php echo $row['coursename']?>" readonly></td>
              <td>Sem:<select name="txtaddsem">
              ...
              <td>Password:<input type="text" name="txtaddpasswd" value="passwd" Placeholder="Name" readonly></td>
          </tr>
          <tr>
            <td colspan="3"><button class="button button3" id="submit">Add</button></td>
            </form>
          </tr>
           <tr>
