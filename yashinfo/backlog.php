  ...
  <div id="container" class="clear"> 
    ...
    <div id="homepage"> 
      ...
      <section id="latest">-->
        ...
        <article>
        <table>
    <form method="post" action="addsubjectat.php">
      <tr>
          
          <td colspan="2">Name:<input type="text" list="browsers" name="txtname" Placeholder="Name">
      ...
      <tr>
          <td colspan='2'>Seat NO:<input type="text" name="seatno"  /></td>
        </tr>
      <tr>
        
        <td>Numbers Of Internal ATKT:<input type="text" name="inter"  /></td>
        <td>Numbers Of External ATKT:<input type="text" name="exter"  /></td>
      </tr>
        ...
        <?php
                                    ...
                                    if($result->num_rows>0)
                                    {
                                        while($row=$result->fetch_assoc())
                                        {
                                            ...
                                            <td><a href="other.php?varname=<?php echo $row['id'];?>">Update</a></td>
