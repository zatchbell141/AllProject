      ...
      <section id="latest">-->
       <h1>Add Others</h1>
        ...
        <article>
          ...
          <table>
            <tr>
              <td colspan="2"> Date:<input type="text"  name="lbdate" value="<?php echo date("d/m/Y");?>" readonly></td>
              
              <td colspan="2"> Receipt No:<input type="text"  name="receipo" value="<?php date_default_timezone_set("Asia/Kolkata"); echo date("Ydmhis");?>" readonly></td>
            
            </tr>
              <tr>
                <td>PRN:<input type="text"  name="txtprn" placeholder="PRN" required></td>
                <td>Name:<input type="text"  name="txtname" placeholder="Name" required></td>
                <td>Lastname:<input type="text"  name="txtlastname" placeholder="Lastname" required></td>
                <td>Year:<input type="text"  name="year" placeholder="Year" required></td>
              </tr>
              <tr>
                <td>Sem:<input type="text"  name="txtsem" placeholder="Sem" required></td>
                <td>Mode:<input type="text"  name="txtmode" placeholder="Mode" required></td>
                <td>Total Fees:<input type="text"  name="txtfees" placeholder="Fees" required></td>
                <td>Paid Fees:<input type="text"  name="txtpaidfees" placeholder="Paid Fees" required></td>
              </tr>
              <tr>
              ...
              <tr>
                 <td colspan="4">Mode:<select class="form-control" name="mode"  width="10px"  required>
              ...
              <tr>
                <td colspan="4"><button class="button button2" id="submit">Add</button></td>
                </form>
              </tr>
              <tr>
