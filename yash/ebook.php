    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
     ...
     <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div>
                <h4>E-Books Upload</h4>
                <form action="ebook.php" method="post"  enctype="multipart/form-data">
                     <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>Book Name:<input type="text" class="form-control" name="txtbname" required></td>
                    ...
                    if(isset($_POST['import']))
                        {
                            ...
                            $year=$_POST['years'];
                            $date=date("d/m/Y");
                            $sql="insert into ebook(year,sem,name,file,date) values('$year','$sem','$text','$image','$date')";
