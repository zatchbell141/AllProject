            ...
            <div id="page-inner">
                ...
                <hr/>
                   ...
                   <td> Cash:
                        <?php
                            ...
                            $name="Cash";
                            $date=date("d/m/Y");
                            $sql="select sum(paid) As 'Total cash' from blacklog where payment='$name' and date='$date'";
                 ...
                 ?>
                    ...
                    <td>Cheque:
                            ...
                            $name="Cheque";
                            $date=date("d/m/Y");
                            $sql="select sum(paid) As 'Total Cheque' from blacklog where payment='$name' and date='$date'";
                            $result=$con->query($sql);
                            $row=$result->fetch_assoc();
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    $name="Cash";
                                     $date=date("d/m/Y");
                                    $sql="select * from blacklog where payment='$name' and date='$date' ORDER BY id DESC";
                                    $result=$con->query($sql);
                ...
                <hr/>
                    ...
                    Total:<?php
                            ...
                            $sql="select sum(paid) As 'Total' from blacklog";
                            $result=$con->query($sql);
                            $row=$result->fetch_assoc();
