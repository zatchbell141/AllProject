                ...
                <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Subject name And Code:<input type="text" class="form-control" name="txtsubjectname" placeholder="Subject Name" required></td>
                                        <td><input type = "submit" class="btn btn-danger"  value ="submit" name="subject"></td>
                                         <?php
                                          $msg=0; 
                                            if($msg==1)
                                            {
                                          ...
                                          if(isset($_POST['subject']))
                                            {
                                                ...
                                                $new="0";
                                         $query="insert into subject(name,new) values('$name','$new')";
