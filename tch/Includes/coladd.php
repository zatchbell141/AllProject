...
$ban=protect($_POST['txtbenbank']);
 ...
 $chcksql="SELECT * FROM `receipt` where FullName='$fullname' and Receipttype='$recpty'";
              ...
              echo '
                        <div class="alert-area">
                            <div class="container">
                             ...
                             <div class="alert alert-danger alert-mg-b-0" role="alert">Receipt already is generated..Receipt No:-'.$chckrow['ReceiptNewNo'].'
                                </div>
                                 </div>
                        </div>
                    </div>
...
$sql="INSERT INTO `receipt`(`id`, `Receipttype`, `ReceiptNewNo`, `ReceiptOld`, `FullName`, `Lastame`, `Name`, `Fathername`, `PRN`, `TRN`, `SeatNO`, `Date`, `Subject`, `Total`, `Balance`, `Paid`, `Late`, `PaymentType`, `ChequeNo`, `ChequeDate`, `Bank`, `Year`, `Sem`, `StdStatus`,`code`,`decp`,`ReceiptMode`,`ben`,`yash`,`active`)
 values('','$recpty','$receiptno','0','$fullname','$lastname','$name','$Fathername','$prn','$trn','0','$date','0','$fees','$Balance','$paid','$Late','$payment','$chqno','$chqd','$bank','$year','$sem','$stdstatus','$cnfno','0','$recem','$ben','1','1')";
