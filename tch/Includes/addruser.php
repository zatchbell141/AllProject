...
include 'Conn.php';
    ...
    $sql="insert into studreg(studentid,fullname,name,lname,PRN,year,sem,username,passwd,recfno,active) values('$studentid','$fullname','$name','$lastname','$prn','$year','$sem','$username','$pswd','0',1)";
