        ...
        ***********************************-->
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">TMV Balance</a></li>
                    </ol>
                </div>
            </div>
        ...
        <!-- Container Fluid-->
          <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">TMV Balance</h4>
                                      <form action="tmvbal.php" method="post">
          ...
          if(isset($_POST['txtsrchuser']))
          {
            ...
            $sql="select * from receipt where FullName='$name' and active=1 and Receipttype='TMVFEES' ORDER BY Date DESC";
         ...
         ?>
          <form action="tmvbal.php" method="POST" autocomplete="off">
          ...
          <table class="table table-sc-ex table-bordered">
             <tr>
              ...
              <td colspan="1">
               ...
               <td colspan="1"><input type="text" class="form-control"  name="txttrn" value="<?php echo $row['TRN'];?>" placeholder="PRN" readonly></td>
            </tr>
              ...
              <tr>
                ...
                <td><input type="text" class="form-control" name="txtrecty" value="TMVFEES" placeholder="Year" readonly></td>
              ...
              <tr>
               <td colspan="4"><input type="text" class="form-control" name="txtfeesmode" value="<?php echo $row['ReceiptMode'];?>"  required></td>
              </tr>
              <tr>
                <td colspan="4"><input type="submit" class="btn btn-primary" value="Submit" name="btnsubmit"></td>
                </form>
              </tr>
              <tr>
                <td colspan="4"><?php include 'Includes/addtmvbalfees.php';?></td>
              </tr>
          </table>
                                </div>
                            </div>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                            ...
                                            <tr class="table-success">
                                             <td><?php echo $row['ReceiptNewNo'];?></td>
                                                ...
                                                <td><button class="btn btn-info" onClick="window.location.href='tmvbalprint.php?varname=<?php echo $row['id'];?>';">Print</button></td>
