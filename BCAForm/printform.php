...
<?php
include 'Inlcudes/bcaConn.php';
$id=$_GET['varname'];
$sql="select * from addonline where tempuserid='$id'";
...
$feessql="select * from receipt where FullName='$fullname' order by id desc";
...
<body>
	...
	<div id="page-wrap">
		...
		<div align="left">
            <br/>
              <img id="image" src="img/bcaform.jpg"  width="300" />
		</div>
		<div align="left">
            <br/>
