        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
					 ...
					 <?php	
	             $count_student=mysql_query("select * from teens ");
							 
	             $count = mysql_num_rows($count_student);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Students Search Result List</div>
...
<tbody>
<?php
		$search_query = mysql_query("select * from teens ")or die(mysql_error());
