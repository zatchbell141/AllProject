...
$Late=protect($_POST['txtlatefees']);
    if($bal>=0)
    {
       ...
       $sql="INSERT INTO `receipt`(`id`, `Receipttype`, `ReceiptNewNo`, `ReceiptOld`, `FullName`, `Lastame`, `Name`, `Fathername`, `PRN`, `TRN`, `SeatNO`, `Date`, `Subject`, `Total`, `Balance`, `Paid`, `Late`, `PaymentType`, `ChequeNo`, `ChequeDate`, `Bank`, `Year`, `Sem`, `StdStatus`,`code`,`decp`,`ReceiptMode`, `yash`,`active`)
 values('','$recpty','$receiptno','0','$fullname','$lastname','$name','$Fathername','$prn','$trn','0','$date','0','$Balance','$bal','$paid','$Late','$payment','$chqno','$chqd','$bank','$year','$sem','$stdstatus','$cnfno','0','$recem','1','1')";
